...
class SetMultiSelectFilterConfigurationDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'itb_lfc_set_itb_lfc_multi_select';
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('itb_lfc_multi_select_id', 'configurationId', MultiSelectListingFilterConfigurationDefinition::class))->addFlags(
                new ApiAware(),
                new PrimaryKey(),
                new Required()
            ),
