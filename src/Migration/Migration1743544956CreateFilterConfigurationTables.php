...
class Migration1743544956CreateFilterConfigurationTables extends MigrationStep
{
    ...
    {
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_checkbox` (
...
SQL;
        ...
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_checkbox_translation` (
    `itb_listing_filter_configuration_checkbox_id` BINARY(16) NOT NULL,
    `language_id` BINARY(16) NOT NULL,
    `display_name` VARCHAR(255) NOT NULL,
    `created_at` DATETIME(3) NOT NULL,
    `updated_at` DATETIME(3) NULL,
    PRIMARY KEY (`itb_listing_filter_configuration_checkbox_id`, `language_id`),
    CONSTRAINT `fk.itb_lfc_translation_checkbox.entity_id` FOREIGN KEY (`itb_listing_filter_configuration_checkbox_id`)
        REFERENCES `itb_listing_filter_configuration_checkbox` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
SQL;
        ...
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_multi_select` (
    `id` BINARY(16) NOT NULL,
    `sales_channel_id` BINARY(16) NULL,
    `dal_field` VARCHAR(255) NOT NULL,
    `enabled` TINYINT(1) NOT NULL,
...
SQL;
        ...
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_multi_select_translation` (
    `itb_listing_filter_configuration_multi_select_id` BINARY(16) NOT NULL,
    `language_id` BINARY(16) NOT NULL,
    `display_name` VARCHAR(255) NOT NULL,
    ...
    `created_at` DATETIME(3) NOT NULL,
    `updated_at` DATETIME(3) NULL,
    PRIMARY KEY (`itb_listing_filter_configuration_multi_select_id`, `language_id`),
    CONSTRAINT `fk.itb_lfc_translation_multi_select.entity_id` FOREIGN KEY (`itb_listing_filter_configuration_multi_select_id`)
        REFERENCES `itb_listing_filter_configuration_multi_select` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
SQL;
        ...
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_range` (
    `id` BINARY(16) NOT NULL,
    `sales_channel_id` BINARY(16) NULL,
    `dal_field` VARCHAR(255) NOT NULL,
    `enabled` TINYINT(1) NOT NULL,
...
SQL;
        ...
        $sql = <<<SQL
CREATE TABLE IF NOT EXISTS `itb_listing_filter_configuration_range_translation` (
    `itb_listing_filter_configuration_range_id` BINARY(16) NOT NULL,
    `language_id` BINARY(16) NOT NULL,
    `display_name` VARCHAR(255) NOT NULL,
    `unit` VARCHAR(255) NULL,
    `created_at` DATETIME(3) NOT NULL,
    `updated_at` DATETIME(3) NULL,
    PRIMARY KEY (`itb_listing_filter_configuration_range_id`, `language_id`),
    CONSTRAINT `fk.itb_lfc_translation_range.entity_id` FOREIGN KEY (`itb_listing_filter_configuration_range_id`)
        REFERENCES `itb_listing_filter_configuration_range` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
