import template from './itb-range-filter-form.html.twig';
...
const rangeFilterForm = Component.register('itb-range-filter-form', {
    ...
    methods: {
        ...
        createNewFilter(): void {
            ...
            this.filter.twigTemplate = '@Storefront/storefront/component/listing/filter/filter-range.html.twig';
            this.filter.unit = '';
            this.isLoading = false;
        },

        loadExistingFilter(): Promise<ITB.RangeFilter> {
        ...
        loadFilterWithLanguage(languageId: string): Promise<ITB.RangeFilter | null> {
            this.isLoading = true;
